...
export default ({ balance, address, rskAddress, type }: ICardProps) => (
  <div className={`d-inline-block text-left ${type}`}>
    <div className="front">
      <div className="strip-bottom"> </div>
      <div className="strip-top"> </div>
      {type === "rif-card" ? (
        <img src={RifLogo} alt="Rif" className="logo" style={{ width: 100 }} />
      ) : (
        <img src={RskLogo} alt="Rsk" className="logo" style={{ width: 100 }} />
      )}
      ...
      <img src={Chip} alt="" className="wave" style={{ width: 100 }} />
